...
class ConfigFeatureOverlapStep(ConfigAnalyzeStep):
    ...
    def run(self) -> Dict[FeatureSharingMetrics, Any]:
        ...
        # Define metrics to retrieve from each method
        ...
        # Get unique features with metrics
        ...
        # Get shared features with metrics
        ...
        # Combine metrics from unique and shared results with edge metrics
